...
class PlayState extends MusicBeatState
{
	...
	public static var ratingStuff:Array<Dynamic> = [
		['Tu e ruim!', 0.2], //From 0% to 19%
		['Que merda', 0.4], //From 20% to 39%
		['Ruim', 0.5], //From 40% to 49%
		['Ta ruim ainda', 0.6], //From 50% to 59%
		['Mais ou menos', 0.69], //From 60% to 68%
		['Legal po', 0.7], //69%
		['Boa mano', 0.8], //From 70% to 79%
		['Gg mane', 0.9], //From 80% to 89%
		['Top dms bro!', 1], //From 90% to 99%
		['TU ARRASA MANO!!', 1] //The value on this one isn't used actually, since Perfect is always "1"
	];
